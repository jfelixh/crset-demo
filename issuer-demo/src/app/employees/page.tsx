    ...
    const publishtoBFC = async () => {
        try {
            ...
            if (!responseForRevoke.ok) {
                throw new Error(`Response is not ok! status: ${responseForRevoke.status}`);
            }
            const responseForUpdatePublish = await fetch("/api/updatePublishById", {
                ...
                body: JSON.stringify({action: "bulkUpdate", users: unpublishedEntries}),
            });
        ...
        <div className="page-container">
            ...
            <div className="flex items-center mb-4 space-x-4 pt-2">
                <Input
                    ...
                    className="flex-1"
                />
                <Dialog open={openDialogue} onOpenChange={setOpenDialogue}> {/* Control dialog visibility */}
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Select the filter options below and click "Apply" to filter the data.
                            </DialogDescription>
                        </DialogHeader>
                                                    ...
                                                    {isDialogOpen && (
                                                        ...
                                                        >
                                                            <div
                                                                ...
                                                                <div
                                                                    className="mt-4 bg-gray-100 p-4 rounded-md font-mono text-sm overflow-y-auto h-[60vh]">
